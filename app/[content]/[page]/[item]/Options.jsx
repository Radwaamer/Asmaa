...
const Options = () => {
    return (
        <div className='lg:flex gap-4 pt-32 text-center'>
            ...
            <a href={`https://wa.me/+201099455472?text=${window.location.href}`} target='blank' className='flex items-center 
            justify-center bg-gold text-white p-3 rounded-lg font-bold gap-3 mb-5 w-full'>
